...
class SettingsInstallment extends AEntity
{
	...
	protected static $associations = [
		'preferredInstallment' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredInstallment::class,
		'preferredDownPayment' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredDownPayment::class,
	];
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredInstallment
	 */
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredDownPayment
	 */
	 ...
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredInstallment $preferredInstallment
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredDownPayment $preferredDownPayment
	 * @param string|null $productCode
	 * @param string|null $productSetCode
	 */
	public function __construct(
		$preferredMonths = null,
		\HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredInstallment $preferredInstallment = null,
		\HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredDownPayment $preferredDownPayment = null,
		$productCode = null,
		$productSetCode = null
	)
	{
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredInstallment
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\SettingsInstallment\PreferredDownPayment
	 */
