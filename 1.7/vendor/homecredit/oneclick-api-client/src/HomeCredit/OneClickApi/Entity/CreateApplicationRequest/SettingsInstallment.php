...
class SettingsInstallment extends AEntity
{
	...
	protected static $associations = [
		'preferredInstallment' => \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredInstallment::class,
		'preferredDownPayment' => \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredDownPayment::class,
	];
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredInstallment
	 */
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredDownPayment
	 */
	 ...
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredInstallment $preferredInstallment
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredDownPayment $preferredDownPayment
	 * @param string|null $productCode
	 * @param string|null $productSetCode
	 */
	public function __construct(
		$preferredMonths = null,
		\HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredInstallment $preferredInstallment = null,
		\HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredDownPayment $preferredDownPayment = null,
		$productCode = null,
		$productSetCode = null
	)
	{
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredInstallment
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationRequest\SettingsInstallment\PreferredDownPayment
	 */
