    ...
    public function initContent()
    {
        ...
        try {
            ...
            if (\Tools::getValue("stateReason") == \Loan::REJECTED) {
                ...
                $this->setTemplate('module:myloanconnector/views/templates/front/rejected.tpl');
            } else {
                $this->setTemplate('module:myloanconnector/views/templates/front/waitForNextStep.tpl');
            }
        } catch (Exception $e) {
