...
class CancelApplicationResponse extends AEntity
{
	...
	protected static $associations = [
		'customer' => \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Customer::class,
		'order' => \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Order::class,
		'settingsInstallment' => \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\SettingsInstallment::class,
	];
	 ...
	 * Customer data
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Customer
	 */
	private $customer;
	 ...
	 * Order data
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Order
	 * @required
	 */
	private $order;
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\SettingsInstallment
	 */
	 ...
	 * @param \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Order $order
	 * @param string $type
	 * @param \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Customer $customer
	 * @param \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\SettingsInstallment $settingsInstallment
	...
	public function __construct(
		...
		$state,
		$stateReason,
		\HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Order $order,
		$type,
		\HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Customer $customer = null,
		\HomeCredit\OneClickApi\Entity\CancelApplicationResponse\SettingsInstallment $settingsInstallment = null,
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Customer
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\Order
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CancelApplicationResponse\SettingsInstallment
	 */
