...
class Order extends AEntity
{
	...
	protected static $associations = [
		'totalPrice' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalPrice::class,
		'totalVat[]' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalVat::class,
		'addresses[]' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Addresses::class,
		'items[]' => \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Items::class,
	];
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalPrice
	 * @required
	 */
	private $totalPrice;
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalVat[]
	 * @required
	 */
	private $totalVat;
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Addresses[]
	 */
	private $addresses;
	 ...
	 * Order items
	 *
	 * @var \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Items[]
	 * @required
	 */
	private $items;
	...
	/**
	 * @param string $number
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalPrice $totalPrice
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalVat[] $totalVat
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Items[] $items
	 * @param string $state
	 * @param array|null $variableSymbols
	 * @param \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Addresses[] $addresses
	 * @param string|null $deliveryType
	 * @param string|null $reservationDate
	 */
	public function __construct(
		$number,
		\HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalPrice $totalPrice,
		array $totalVat,
		array $items,
		$state,
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalPrice
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\TotalVat[]
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Addresses[]
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\GetApplicationDetailResponse\Order\Items[]
	 */
