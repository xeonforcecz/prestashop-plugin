...
namespace HomeCredit\OneClickApi\Entity\CreateApplicationResponse;
...
class Order extends AEntity
{
	...
	protected static $associations = [
		'totalPrice' => \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalPrice::class,
		'totalVat[]' => \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalVat::class,
		'addresses[]' => \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Addresses::class,
		'items[]' => \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Items::class,
	];
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalPrice
	 * @required
	 */
	private $totalPrice;
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalVat[]
	 * @required
	 */
	private $totalVat;
	 ...
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Addresses[]
	 */
	private $addresses;
	 ...
	 * Order items
	 *
	 * @var \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Items[]
	 * @required
	 */
	private $items;
	...
	/**
	 * @param string $number
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalPrice $totalPrice
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalVat[] $totalVat
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Items[] $items
	 * @param string $state
	 * @param array|null $variableSymbols
	 * @param \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Addresses[] $addresses
	 * @param string|null $deliveryType
	 * @param string|null $reservationDate
	 */
	public function __construct(
		$number,
		\HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalPrice $totalPrice,
		array $totalVat,
		array $items,
		$state,
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalPrice
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\TotalVat[]
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Addresses[]
	 */
	...
	/**
	 * @return \HomeCredit\OneClickApi\Entity\CreateApplicationResponse\Order\Items[]
	 */
